...
var subCmd = &cobra.Command{
	Use:   "sub",
	Short: "Subtract second number from first ",
	Long: `It takes two number as operands and give output result of subtraction of second integer from first integer`,
